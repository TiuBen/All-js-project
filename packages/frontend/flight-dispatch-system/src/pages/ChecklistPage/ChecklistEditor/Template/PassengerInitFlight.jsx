...
// 约定：模板导出标识符 = 文件名（passengerInitFlight）；视频监管用大写下划线常量
import passengerInitFlight from "../../utils/passengerInitFlight";
 ...
 * @param {Object}   props.template    当前模板（= 客运始发航班）
...
export default function PassengerInitFlight({
    ...
    const nodes = passengerInitFlight?.schema || [];
                ...
                },
                {
                    ...
                    content: (
                        <VideoPanel
                            ...
                            category={passengerInitFlight?.category ?? template?.category}
