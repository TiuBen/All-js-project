...
// 约定：模板导出标识符 = 文件名（cargoInitFlight）；视频监管用大写下划线常量
import cargoInitFlight from "../../utils/cargoInitFlight";
 ...
 * @param {Object}   props.template    当前模板（= 货运始发航班）
...
export default function CargoInitFlight({
    ...
    const nodes = cargoInitFlight?.schema || [];

    // 视频监管项数（货运版，隐藏 applicable="客运" 条目）
                ...
                },
                {
                    ...
                    content: (
                        <VideoPanel
                            ...
                            category={cargoInitFlight?.category ?? template?.category}
