 ...
 * 客运过站航班 —— 节点保障检查单静态数据
 * ------------------------------------------------------------
 * 由后端 data/checklists/节点保障/客运过站航班.json 全量内联而来。
 * 编译期即随前端产物打包，不再请求 /api/checklists/templates。
 * 顶层字段：uuid / category / checklistName / schemaVersion / generatedAt / variables / parameters / schema
 ...
 * ============================================================
 */
export const passengerBypassFlight = {
    "uuid": "69452c28-7eb8-4c09-aed4-f7c48d7854dc",
    "category": "客运过站航班",
    "checklistName": "过站航班",
    "schemaVersion": "3.0-passenger",
    "generatedAt": "2026-08-31T01:30:00.000000",
    "variables": {
        "estimatedLanding": {
            "name": "预计落地时间",
            "type": "datetime",
        ...
        "aircraftSeats": {
            ...
            "description": "用于轮挡与反光锥形标志物放置时间查表"
        }
    },
    "parameters": [
        {
            "code": "CHOCK_PLACEMENT_TIME",
            "name": "轮挡与反光锥形标志物放置时间",
            "type": "aircraft_seats",
            "unit": "minutes",
            "description": "按机型座位级别查表，500+→4、251-500→4、151-250→3、61-150→3、60-→2",
            "values": {
                "500+": 4,
                "251-500": 4,
                "151-250": 3,
    ...
    "schema": [
        ...
        },
        {
            ...
            "formula": {
                ...
                "left": {
                    ...
                    "target": "event",
                    "time": "actual",
                    "refUUID": "171b4956-e417-471a-bc1d-334d190f72c6"
                },
                "right": {
                    "type": "literal",
                    "value": 5,
        ...
        },
        {
            ...
            "formula": {
                ...
                "target": "event",
                "time": "actual",
                "refUUID": "555a9601-fbb8-4c0d-adcd-dcdeaaaeb5bb"
            },
            "auxiliaries": []
        },
        {
        ...
        },
        {
            ...
            "eventId": "E012",
            "code": "HANDLER_AND_EQUIPMENT_ARRIVAL",
            "category": "main",
            "type": "客运",
            "responsible": "赛福威",
            "name": "装卸人员及装卸设备",
        ...
        },
        {
            ...
            "formula": {
                ...
                "target": "event",
                "time": "actual",
                "refUUID": "9ce4bce8-77f3-4a73-9445-e6ea15b8b1ee"
            },
            "auxiliaries": []
        },
        {
...
export default passengerBypassFlight
