...
const LeftNavItem = ({ title, page, Icon, isExpanded, subNav }: LeftNavItemProps) => {
...
const items = [
    {
        ...
        Icon: (props: any) => <MessageCircle {...props} strokeWidth={1.5} />,
        active: true,
        subNav: [
            {
                title: "岗位状态",
                page: Pages.DUTY,
                Icon: (props?: any) => <BicepsFlexed {...props} strokeWidth={1.5} />,
            },
            {
                title: "日历",
                page: Pages.CALENDAR,
                Icon: (props?: any) => <CalendarDays {...props} strokeWidth={1.5} />,
            },
            {
                title: "统计",
                page: Pages.STATS,
                Icon: (props?: any) => <ChartLine {...props} size={"1.5em"} strokeWidth={1.5} />,
            },
        ],
    },
    {
        ...
        Icon: (props: any) => <ClipboardPenLine {...props} strokeWidth={1.5} />,
        subNav: [
            {
                title: "执勤表格",
                page: Pages.ADMIN_SHEET,
                Icon: (props?: any) => <Sheet {...props} size={"1.5em"} strokeWidth={1.5} />,
            },
            {
                title: "设置",
                page: Pages.ADMIN_SETTING,
                Icon: (props?: any) => <Settings {...props} size={"1.5em"} strokeWidth={1.5} />,
            },
            {
                title: "导出",
                page: Pages.ADMIN_EXPORT,
                Icon: (props?: any) => <FileDown {...props} size={"1.5em"} strokeWidth={1.5} />,
            },
        ],
    },
];
