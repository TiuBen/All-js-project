...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active]:focus:bg-neutral-100 data-[active]:hover:bg-neutral-100 data-[active]:bg-neutral-100 data-[active]:text-neutral-900 hover:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-900 focus-visible:ring-neutral-950/50 [&_svg:not([class*='text-'])]:text-neutral-500 flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 dark:data-[active]:focus:bg-neutral-800 dark:data-[active]:hover:bg-neutral-800 dark:data-[active]:bg-neutral-800 dark:data-[active]:text-neutral-50 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:focus-visible:ring-neutral-300/50 dark:[&_svg:not([class*='text-'])]:text-neutral-400",
        className
      )}
      {...props}
    />
