...
function calculateMonthlyNightShiftCount(year, month) {
        ...
        DutyDb.all(sql, [`${endDate} 08:30:00`, `${startDate} 18:00:00`], (err, rows) => {
            ...
            for (const userId in userMap) {
                ...
                for (let d = 1; d <= daysInMonth; d++) {
                    ...
                    if (
                        dayResult["1800-2100"] > 0.7 ||
                        dayResult["2100-2400"] > 0.7 ||
                        dayResult["+1天0000-0830"] > 0.7
                    ) {
                        dayResult["夜班次数"] = 1;
                    }
...
module.exports = { calculateMonthlyNightShiftCount };
