...
const { OutputDdToExcel } = require("./utils/OutputDdToExcel");
OutputDdToExcel();
...
//     // Query with rowMode: 'array'
//     db.all(
//         `SELECT * FROM users`,
//         // { rowMode: 'array' }, // Specify rowMode
//         (err, rows) => {
//             if (err) {
...
// const { AllSumTimeWithFilter } = require("./utils/CONST");
// (async () => {
//     console.log("ddddddddddddddddddddddddddddddddddddddddddd");
//     const _test = await GetDutyRows({ startDate: "2025-01-01", endDate: "2025-01-31" }, db);

//     console.log(_test);

//     console.log("ddddddddddddddddfd");
//     // 更新 AllSumTimeWithFilter
//     const calculatedTimes = SumTimeByField(_test, AllSumTimeWithFilter);
//     AllSumTimeWithFilter.totalTime = calculatedTimes.totalTime;
//     AllSumTimeWithFilter.totalEastTowerTime.time = calculatedTimes.totalEastTowerTime;
//     AllSumTimeWithFilter.totalWestTowerTime.time = calculatedTimes.totalWestTowerTime;
//     AllSumTimeWithFilter.totalGroundTime.time = calculatedTimes.totalGroundTime;
//     AllSumTimeWithFilter.totalTeacherTime.time = calculatedTimes.totalTeacherTime;
//     AllSumTimeWithFilter.totalStudentTime.time = calculatedTimes.totalStudentTime;

//     console.log( JSON.stringify(AllSumTimeWithFilter));
//     console.log( JSON.stringify(calculatedTimes));
// })();
