                                    ...
                                    return new Promise((resolve, reject) => {
                                        db.get(getRoleTimeSql, async function (err, oneRow) {
                                            if (err) {
                                                ...
                                                let _outTime =
                                                    outTime === null ? dayjs().format("YYYY-MM-DD HH:mm:ss") : outTime;
...
async function GetStatistics(req, res) {
    ...
    if (username) {
        const user = {};
        const dutyTime = await _calTimeDurationArray(username, startDate, endDate, startTime , endTime );
        console.log("=========================================================");
