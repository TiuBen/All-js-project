...
async function exportAsExcel(
    ...
    simpleDutyWorksheet.getCell("J2").value = "总小时数";
    simpleDutyWorksheet.getCell("K2").value = "夜班段数";
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        simpleDutyWorksheet.getCell(`K${i + 3}`).value = nightsCount?.[username]?.[needMonth]?.["夜班段数"] || "";
