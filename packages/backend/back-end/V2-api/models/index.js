...
// * 添加 不同的 数据 表格 到 数据库中
// *    报价单
const Quotation = require("./utils/quotation.model")(sequelize);
// *    供应商
const Supplier = require("./utils/supplier.model")(sequelize);
// *    员工
const User = sequelize.define("user", require("./utils/user.model"));
// *    考勤
const CheckIn =require('./utils/checkIn.model')(sequelize);
// *通知
const WebsocketInfo=require('./utils/websocketInfo.model')(sequelize);
// * 这个是 公司信息
const { companyModel } = require("./utils/company.model");
const Company = sequelize.define("company", companyModel);

// @STEP 这个是 表单模板 的存储
db.formTemplate = require("./utils/formTemplate.model")(sequelize);
// @STEP 这里保存所有的表单
db.form = require("./utils/forms.model")(sequelize);
// @STEP 这里 名片
db.businessCard = require("./utils/businessCard.model")(sequelize);
